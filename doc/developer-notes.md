...
Charm Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 17888 for connections and services them.
...
However, in open source software such as Charm Core, where everyone uses
...
pay attention to for reviewers of Charm Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Charm Core uses tinyformat, which is type safe. Leave them out to avoid confusion
