...
This mechanism has been integrated into Bitcore-Node-Charm which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/charmcoin/insight-api-charm#web-socket-api](https://github.com/charmcoin/insight-api-charm#web-socket-api) 
* API: [https://github.com/charmcoin/insight-api-charm#instantsend-transactions](https://github.com/charmcoin/insight-api-charm#instantsend-transactions) 
...
By default, the Charm Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Charm Core daemon:
