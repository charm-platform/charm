    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Charm Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Charm Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  charm-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Charm in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CHARM, 0.1 CHARM, 1 CHARM and 10 CHARM -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Charm Core is shutting down...") + "<br /><br />" +
