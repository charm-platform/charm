    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Charm Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Charm address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and charm: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Charm Core"), this);
    aboutAction->setStatusTip(tr("Show information about Charm Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Charm Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Charm addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Charm addresses"));
    ...
    openAction->setStatusTip(tr("Open a charm: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Charm Core help message to get a list with possible Charm Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Charm Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Charm network", "", count));
}
...
{
    QString strTitle = tr("Charm Core"); // default title
