    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CHARM-light"), QVariant("light"));
    ui->theme->addItem(QString("CHARM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CHARM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CHARM-traditional"), QVariant("trad"));
