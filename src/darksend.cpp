...
{
    if(fLiteMode) return; // ignore all Charm related functionality
...
/*
    ...
    allow endless transaction that would bloat Charm and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("charm-privatesend");
