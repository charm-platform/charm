 ...
 *
 *   // network
 *   CCharmNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.charm.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCharmNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CharmNetwork
// //   -- signature requirements : Key1(User)
// class CCharmNetworkVariable : public CGovernanceObject
// {
// private:
