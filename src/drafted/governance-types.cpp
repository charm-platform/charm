...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CharmNetwork") type = CharmNetwork;
    if(strType == "CharmNetworkVariable") type = CharmNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CharmNetwork) s = "CharmNetwork";
    if(type == CharmNetworkVariable) s = "CharmNetworkVariable";
